...
<body>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image6.jpg') }}" alt="Image 6" class="rounded-image" data-category="girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image7.jpg') }}" alt="Image 7" class="rounded-image" data-category="girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image8.jpg') }}" alt="Image 8" class="rounded-image" data-category="girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image9.jpg') }}" alt="Image 9" class="rounded-image" data-category="boys">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image10.jpg') }}" alt="Image 10" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image11.jpg') }}" alt="Image 11" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image12.jpg') }}" alt="Image 12" class="rounded-image" data-category="boys fathers">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image13.jpg') }}" alt="Image 13" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image14.jpg') }}" alt="Image 14" class="rounded-image" data-category="fathers">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image15.jpg') }}" alt="Image 15" class="rounded-image" data-category="boys">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image16.jpg') }}" alt="Image 16" class="rounded-image" data-category="girls boys">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image17.jpg') }}" alt="Image 17" class="rounded-image" data-category="girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image18.jpg') }}" alt="Image 18" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image19.jpg') }}" alt="Image 19" class="rounded-image" data-category="girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image20.jpg') }}" alt="Image 20" class="rounded-image" data-category="boys">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image21.jpg') }}" alt="Image 21" class="rounded-image" data-category="girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image22.jpg') }}" alt="Image 22" class="rounded-image" data-category="boys">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image23.jpg') }}" alt="Image 23" class="rounded-image" data-category="girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image24.jpg') }}" alt="Image 24" class="rounded-image" data-category="girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image26.jpg') }}" alt="Image 26" class="rounded-image" data-category="girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image27.jpg') }}" alt="Image 27" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image28.jpg') }}" alt="Image 28" class="rounded-image" data-category="girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image29.jpg') }}" alt="Image 29" class="rounded-image" data-category="boys">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image30.jpg') }}" alt="Image 30" class="rounded-image" data-category="girls boys">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image31.jpg') }}" alt="Image 31" class="rounded-image" data-category="girls boys">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image32.jpg') }}" alt="Image 32" class="rounded-image" data-category="mothers girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image33.jpg') }}" alt="Image 33" class="rounded-image" data-category="mothers girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image36.jpg') }}" alt="Image 36" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image39.jpg') }}" alt="Image 39" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image40.jpg') }}" alt="Image 40" class="rounded-image" data-category="fathers">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image43.jpg') }}" alt="Image 43" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image47.jpg') }}" alt="Image 47" class="rounded-image" data-category="boys">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image48.jpg') }}" alt="Image 48" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image51.jpg') }}" alt="Image 51" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image55.jpg') }}" alt="Image 55" class="rounded-image" data-category="boys">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image56.jpg') }}" alt="Image 56" class="rounded-image" data-category="girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image59.jpg') }}" alt="Image 59" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image64.jpg') }}" alt="Image 64" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image67.jpg') }}" alt="Image 67" class="rounded-image" data-category="girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image68.jpg') }}" alt="Image 68" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image71.jpg') }}" alt="Image 71" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image72.jpg') }}" alt="Image 72" class="rounded-image" data-category="boys">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image76.jpg') }}" alt="Image 76" class="rounded-image" data-category="boys">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image80.jpg') }}" alt="Image 80" class="rounded-image" data-category="girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image83.jpg') }}" alt="Image 83" class="rounded-image" data-category="girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image87.jpg') }}" alt="Image 87" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image91.jpg') }}" alt="Image 91" class="rounded-image" data-category="girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image92.jpg') }}" alt="Image 92" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image95.jpg') }}" alt="Image 95" class="rounded-image" data-category="boys">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image96.jpg') }}" alt="Image 96" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image99.jpg') }}" alt="Image 99" class="rounded-image" data-category="girls mothers">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image100.jpg') }}" alt="Image 100" class="rounded-image" data-category="boys">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image103.jpg') }}" alt="Image 103" class="rounded-image" data-category="girls">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image104.jpg') }}" alt="Image 104" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image107.jpg') }}" alt="Image 107" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
    ...
    <div class="image-grid">
        ...
        <div class="column">
            <img src="{{ asset('images/Birthday_Cakes/image111.jpg') }}" alt="Image 111" class="rounded-image" data-category="common">
            <button class="show-details-button">
                Show Details <i class="fas fa-arrow-right"></i>
            </button>
        </div>
